...
<?php
	...
	if( isset($zerif_aboutus_show) && $zerif_aboutus_show != 1 ):
  	...
  	$zerif_linhaprodutos_show = get_theme_mod('zerif_linhaprodutos_show');

  	if( isset($zerif_linhaprodutos_show) && $zerif_linhaprodutos_show != 1 ):
  		include get_template_directory() . "/sections/linha_produtos.php";
  	endif;
  ...
  $zerif_certificacoes_show = get_theme_mod('zerif_certificacoes_show');

  if( isset($zerif_certificacoes_show) && $zerif_certificacoes_show != 1 ):

    include get_template_directory() . "/sections/certificacoes.php";
  endif;


  /* ONDE ESTAMOS */

  $zerif_onde_estamos_show = get_theme_mod('zerif_onde_estamos_show');

  if( isset($zerif_onde_estamos_show) && $zerif_onde_estamos_show != 1 ):

    include get_template_directory() . "/sections/onde_estamos.php";
  endif;
				...
				<div class="row">
					...
					<form role="form" method="POST" action="" onSubmit="this.scrollPosition.value=(document.body.scrollTop || document.documentElement.scrollTop)" class="contact-form">
						...
						<div class="col-lg-4 col-sm-4" data-scrollreveal="enter left after 0s over 1s">
							...
							<input required="required" type="text" name="myname" placeholder="Nome" class="form-control input-box" value="<?php if(isset($_POST['myname'])) echo esc_attr($_POST['myname']);?>">
						...
						<div class="col-lg-4 col-sm-4" data-scrollreveal="enter left after 0s over 1s">
							...
							<input required="required" type="text" name="mysubject" placeholder="Assunto" class="form-control input-box" value="<?php if(isset($_POST['mysubject'])) echo esc_attr($_POST['mysubject']);?>">

						</div>

						<div class="col-lg-12 col-sm-12" data-scrollreveal="enter right after 0s over 1s">

							<textarea name="mymessage" class="form-control textarea-box" placeholder="Mensagem"><?php if(isset($_POST['mymessage'])) { echo esc_html($_POST['mymessage']); } ?></textarea>
