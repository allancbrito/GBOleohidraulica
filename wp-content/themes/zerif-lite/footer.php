...
<div class="container">
	...
	<?php
		...
		$zerif_socials_google = get_theme_mod('zerif_socials_google','#');
		...
		if(!empty($zerif_socials_facebook) || !empty($zerif_socials_twitter) || !empty($zerif_socials_linkedin) || !empty($zerif_socials_behance) || !empty($zerif_socials_google) || !empty($zerif_socials_dribbble) ||
		...
		!empty($zerif_copyright)):
					...
					if(!empty($zerif_socials_facebook) || !empty($zerif_socials_twitter) || !empty($zerif_socials_linkedin) || !empty($zerif_socials_behance) || !empty($zerif_socials_google) || !empty($zerif_socials_dribbble)):
						...
						/* google+ */
						if( !empty($zerif_socials_google) ):
							echo '<li><a target="_blank" href="'.esc_url(__($zerif_socials_google,'zerif-lite')).'"><i class="fa fa-google-plus"></i></a></li>';
						endif;
						/* dribbble */
