...
function zerif_widgets_init()
{
    ...
    register_sidebar(array(
        ...
        'name' => __('Cases de sucesso', 'zerif-lite'),
    ...
    register_sidebar(array(
        ...
        'name' => __('Certificacoes', 'zerif-lite'),

        'id' => 'sidebar-certificacoes',
    ...
    register_sidebar(array(
        ...
        'name' => __('Linha de produtos', 'zerif-lite'),

        'id' => 'sidebar-linhaprodutos',
    ...
    register_sidebar(array(
        ...
        'name' => __('Onde estamos', 'zerif-lite'),

        'id' => 'sidebar-onde_estamos',
    ...
    register_sidebar(array(
        ...
        'name' => __('Nossas empresas', 'zerif-lite'),
...
class zerif_ourfocus extends WP_Widget
{
    ...
    function widget($args, $instance)
    {
        ...
        <div class="col-lg-3 col-sm-3 focus-box" data-scrollreveal="enter left after 0.15s over 1s">
            ...
            <h5><?php if( !empty($instance['title']) ): echo apply_filters('widget_title', $instance['title']); endif; ?></h5>
            <!-- FOCUS HEADING -->
