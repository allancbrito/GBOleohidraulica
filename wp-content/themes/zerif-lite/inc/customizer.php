...
function zerif_customize_register( $wp_customize ) {
	...
	if ( class_exists( 'WP_Customize_Panel' ) ):
		...
		/* google+ */
		$wp_customize->add_setting( 'zerif_socials_google', array('sanitize_callback' => 'esc_url_raw','default' => '#'));
		$wp_customize->add_control( 'zerif_socials_google', array(
				'label'    => __( 'Google+ link', 'zerif-lite' ),
				'section'  => 'zerif_general_socials_section',
				'settings' => 'zerif_socials_google',
				'priority'    => 8,
		));
		/* dribbble */
		...
		/* google+ */
		$wp_customize->add_setting( 'zerif_socials_google', array('sanitize_callback' => 'esc_url_raw','default' => '#'));
		$wp_customize->add_control( 'zerif_socials_goole', array(
				'label'    => __( 'Google+ link', 'zerif-lite' ),
				'section'  => 'zerif_general_section',
				'settings' => 'zerif_socials_google',
				'priority'    => 8,
	...
	if ( class_exists( 'WP_Customize_Panel' ) ):
		...
		$wp_customize->add_panel( 'panel_about', array(
			...
			'capability' => 'edit_theme_options',
			'theme_supports' => '',
			'title' => __( 'Quem somos', 'zerif-lite' )
		) );
	...
	/*************  LINHA PRODUTOS **********************************/
	/********************************************************************/
	$wp_customize->add_section( 'zerif_linhaprodutos_section' , array(
			'title'       => __( 'Linha de produtos', 'zerif-lite' ),
					'priority'    => 32,

			'description' => __( 'The main content of this section is customizable in: Customize -> Widgets -> Linha de produtos section. There you must add the "Zerif - Linha de produtos widget"', 'zerif-lite' )
	));
	/* show/hide */
	$wp_customize->add_setting( 'zerif_linhaprodutos_show', array('sanitize_callback' => 'zerif_sanitize_text'));
		$wp_customize->add_control(
		'zerif_linhaprodutos_show',
		array(
			'type' => 'checkbox',
			'label' => __('Hide linha produtos section?','zerif-lite'),
			'section' => 'zerif_linhaprodutos_section',
			'priority'    => 1,
		)
	);
	/* linha produtos title */
	$wp_customize->add_setting( 'zerif_linhaprodutos_title', array('sanitize_callback' => 'zerif_sanitize_text','default' => __('FEATURES','zerif-lite')));

		$wp_customize->add_control( 'zerif_linhaprodutos_title', array(
				'label'    => __( 'Title', 'zerif-lite' ),
				'section'  => 'zerif_linhaprodutos_section',
				'settings' => 'zerif_linhaprodutos_title',
				'priority'    => 2,
	));
	/* linha produtos subtitle */
	$wp_customize->add_setting( 'zerif_linhaprodutos_subtitle', array('sanitize_callback' => 'zerif_sanitize_text','default' => __('What makes this single-page WordPress theme unique.','zerif-lite')));
	$wp_customize->add_control( 'zerif_linhaprodutos_subtitle', array(
			'label'    => __( 'Linha produtos subtitle', 'zerif-lite' ),
					'section'  => 'zerif_linhaprodutos_section',
					'settings' => 'zerif_linhaprodutos_subtitle',
			'priority'    => 3,
	));
	...
	$wp_customize->add_section( 'zerif_ourteam_section' , array(
			'title'       => __( 'Nossas empresas', 'zerif-lite' ),
    	  	'priority'    => 35,
	...
	$wp_customize->add_section( 'zerif_testimonials_section' , array(
			'title'       => __( 'Cases de sucesso', 'zerif-lite' ),
    	  	'priority'    => 36,
	...
	$wp_customize->add_section( 'zerif_certificacoes_section' , array(
			'title'       => __( 'Certificacoes', 'zerif-lite' ),
    	  	'priority'    => 36,
			'description' => __( 'The main content of this section is customizable in: Customize -> Widgets -> Testimonials section. There you must add the "Zerif - Testimonial widget"', 'zerif-lite' )
	));
	/* certificacoes show/hide */
	$wp_customize->add_setting( 'zerif_certificacoes_show', array('sanitize_callback' => 'zerif_sanitize_text'));
    $wp_customize->add_control(
		'zerif_certificacoes_show',
		array(
			'type' => 'checkbox',
			'label' => __('Hide certificacoes section?','zerif-lite'),
			'section' => 'zerif_certificacoes_section',
			'priority'    => 1,
		)
	);
	/* certificacoes title */
	$wp_customize->add_setting( 'zerif_certificacoes_title', array('sanitize_callback' => 'zerif_sanitize_text','default' => __('Certificacoes','zerif-lite')));
	$wp_customize->add_control( 'zerif_certificacoes_title', array(
				'label'    => __( 'Title', 'zerif-lite' ),
				'section'  => 'zerif_certificacoes_section',
				'settings' => 'zerif_certificacoes_title',
				'priority'    => 2,
	));
	/* certificacoes subtitle */
	$wp_customize->add_setting( 'zerif_certificacoes_subtitle', array('sanitize_callback' => 'zerif_sanitize_text'));
	$wp_customize->add_control( 'zerif_certificacoes_subtitle', array(
			'label'    => __( 'Certificacoes subtitle', 'zerif-lite' ),
	      	'section'  => 'zerif_certificacoes_section',
	      	'settings' => 'zerif_certificacoes_subtitle',
			'priority'    => 3,
	));
	/*************** FIM CERTIFICACOES ****************/
	...
	$wp_customize->add_section( 'zerif_latestnews_section' , array(
			'title'       => __( 'Noticias e novidades', 'zerif-lite' ),
    	  	'priority'    => 37
	));
	...
	$wp_customize->add_section( 'zerif_onde_estamos_section' , array(
			'title'       => __( 'Onde estamos', 'zerif-lite' ),
					'priority'    => 36,
			'description' => __( 'The main content of this section is customizable in: Customize -> Widgets -> Onde estamos section. There you must add the "Zerif - Testimonial widget"', 'zerif-lite' )
	));
	/* onde_estamos show/hide */
	$wp_customize->add_setting( 'zerif_onde_estamos_show', array('sanitize_callback' => 'zerif_sanitize_text'));
		$wp_customize->add_control(
		'zerif_onde_estamos_show',
		array(
			'type' => 'checkbox',
			'label' => __('Hide onde estamos section?','zerif-lite'),
			'section' => 'zerif_onde_estamos_section',
			'priority'    => 1,
		)
	);
	/* onde estamos title */
	$wp_customize->add_setting( 'zerif_onde_estamos_title', array('sanitize_callback' => 'zerif_sanitize_text','default' => __('Onde estamos','zerif-lite')));
	$wp_customize->add_control( 'zerif_onde_estamos_title', array(
				'label'    => __( 'Title', 'zerif-lite' ),
				'section'  => 'zerif_onde_estamos_section',
				'settings' => 'zerif_onde_estamos_title',
				'priority'    => 2,
	));
	/* onde estamos subtitle */
	$wp_customize->add_setting( 'zerif_onde_estamos_subtitle', array('sanitize_callback' => 'zerif_sanitize_text'));
	$wp_customize->add_control( 'zerif_onde_estamos_subtitle', array(
			'label'    => __( 'Onde estamos subtitle', 'zerif-lite' ),
					'section'  => 'zerif_onde_estamos_section',
					'settings' => 'zerif_onde_estamos_subtitle',
			'priority'    => 3,
	));
	/*************** ONDE ESTAMOS ****************/
